          ...
          <div className="bg-[#08080a] border border-white/5 rounded-[40px] p-10 space-y-8 shadow-2xl relative overflow-hidden group">
            ...
            <div className="space-y-3 relative z-10">
              ...
              <input
                ...
                className="w-full bg-[#111113] border border-white/10 rounded-2xl px-6 py-4 text-white placeholder-slate-500 focus:border-[#d4af37]/50 outline-none transition-all text-sm italic"
              />
            </div>
            ...
            <div className="space-y-3 relative z-10">
              ...
              <textarea
                ...
                className="w-full bg-[#111113] border border-white/10 rounded-2xl px-6 py-4 text-white placeholder-slate-500 h-40 focus:border-[#d4af37]/50 outline-none transition-all resize-none text-sm italic leading-relaxed"
              />
            </div>
