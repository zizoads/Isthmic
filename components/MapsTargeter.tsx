        ...
        <div className="relative z-10">
          ...
          <div className="flex gap-4">
            <input 
              ...
              placeholder='Enter domain or niche (e.g. "Pizza restaurant")...'
            />
            <button 
            ...
            <div className="space-y-4">
                ...
                chunk.maps && (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-[9px] text-slate-400 uppercase font-bold">Google Maps Link</div>
                    </div>
                  </a>
                )
              ))}
              {results.sources.length === 0 && (
                <div className="py-20 text-center opacity-20">
                  ...
                  <p className="text-[10px] font-black uppercase tracking-widest">No map sources found</p>
                </div>
              )}
            </div>
          </div>
