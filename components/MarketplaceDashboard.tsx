...
const MarketplaceDashboard: React.FC<Props> = ({ domains }) => {
  ...
  const isMarketConnected = true; // Simplified for radical purge
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="lg:col-span-1 bg-[#08090d] border border-white/5 rounded-[40px] flex flex-col h-[750px] overflow-hidden">
          <div className="p-8 border-b border-white/5 bg-white/2">
             <h3 className="text-[10px] font-black text-slate-400 uppercase tracking-widest">LIQUIDATION QUEUE</h3>
          </div>
